...
final class Preview {
    static let vm = {
        ...
        vm.schoolSelected = SchoolsModel(id: 197, name: "jose", color: Color.blue.toHex(), imgurl: "https://xvkymhtcipdbdanikzpq.supabase.co/storage/v1/object/public/img//21EAA953-B686-4DA3-8847-D3D7B17C7852")
